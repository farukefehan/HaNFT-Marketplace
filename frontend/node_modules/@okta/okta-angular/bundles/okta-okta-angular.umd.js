(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    OktaCallbackComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OktaCallbackComponent, deps: [{ token: OKTA_CONFIG }, { token: OKTA_AUTH }, { token: i0__namespace.Injector, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    var OktaAuthFactoryService = /** @class */ (function () {
        ...
        OktaAuthFactoryService.setupOktaAuth = function (oktaAuth, router, location) {
            ...
            if (!isAuthJsSupported) {
                throw new i1.AuthSdkError("Passed in oktaAuth is not compatible with the SDK, minimum supported okta-auth-js version is ".concat(packageInfo.authJSMinSupportedVersion, "."));
            }
            // Add Okta UA
            ...
            if (!oktaAuth.options.restoreOriginalUri && router && location) {
                oktaAuth.options.restoreOriginalUri = function (_, originalUri) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        routePath = i1.toRelativeUrl(originalUri || '/', baseUrl);
